...
screen_coords = {
    ...
    'round_pos': vec4(767, 10, 870, 31, True),
    'round_pos_two': vec4(2, 0, 42, 21, False),
    'round_pos_one': vec4(57, 1, 96, 21, False),

    'shop_pos': vec4(481, 1039, 1476, 1070),
    'champ_name_pos': [vec4(3, 5, 120, 24), vec4(204, 5, 320, 24), vec4(407, 5, 522, 24), vec4(608, 5, 712, 24), vec4(808, 5, 912, 24)], # Relative to shop pos

    'gold_pos': vec4(870, 883, 920, 909),

    'loading_screen_pos': vec4(1718, 636, 79, 77),
    ...
    'item_pickup_loc': [vec2(1427, 611), vec2(406, 544), vec2(1412, 486), vec2(469, 440), vec2(1380, 381), vec2(644, 323), vec2(1297, 262), vec2(590, 215)],

    'bench_loc': [vec2(425, 777), vec2(542, 777), vec2(658, 777), vec2(778, 777), vec2(892, 777), vec2(1010, 777), vec2(1128, 777), vec2(1244, 777), vec2(1359, 777)],
...
def get_coords(key: str):
    return screen_coords[key]
